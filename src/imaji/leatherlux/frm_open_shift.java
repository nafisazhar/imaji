 ...
 * @author Hp
 */
public class frm_open_shift extends javax.swing.JFrame {

    /**
     * Creates new form openshift
     */
    public frm_open_shift() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(347, 45));

        jLabel1.setFont(new java.awt.Font("Arial", 1, 36)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(245, 244, 240));
        jLabel1.setText("Saldo Tunai");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frm_open_shift.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frm_open_shift().setVisible(true);
            }
        });
    }
